---
title: "Enrichir ses données avec OpenRefine et le processus de réconciliation"
subtitle: "Exemple avec le service de réconciliation de Wikidata"
lang: fr
author:
...
date: "2025-03-12"
abstract: ""
keywords: "OpenRefine; Wikidata; réconciliation; enrichissement des données"
...
[Installer OpenRefine](https://openrefine.org/download.html) sur son ordinateur (Windows, Mac OS ou Linux). Comme c'est un programme qui s'execute dans le navigateur, il n'est pas nécessaire d'avoir des droits d'administrateur pour l'installer.

## Choisir un jeu de données

Nous allons utiliser un jeu de données sous la forme d'une liste de douze ouvrages d'alchimie en deux colonnes : `Titre` (pour le titre de l'ouvrage) et `Date` (pour date de publication, certaines dates sont manquantes). Ce jeu de données ([télégeableable](/data/traites-alchimie.csv)) est sous la forme d'un fichier CSV encodé en UTF-8 (voir Figure 1). C'est un format ouvert idéal pour traiter et archiver des données tabulées. Veuillez noter que les résultats présentés ci-dessous peuvent se présenter différemment si vous refaites les mêmes actions, car les données de Wikidata auront changé.

![Figure 1. - Apercu du fichier CSV](images/figure1-apercu-csv.png)
...
![Figure 2. - Démarrer la réconciliation](images/figure2-demarrer-reconciliation.png)
...
![Figure 3. - Options de réconciliation.](images/figure3-options.png)
...
![Figure 4. - Exemple de donnée réconciliée](images/figure4-exemple-donnee-reconciliee.png)
...
![Figure 5. - Exemple de donnée non-réconciliée avec un choix à effectuer](images/figure5-exemple-donnee-nonreconciliee.png)
...
Pour aller plus loin, se rendre à la section [Comment améliorer la réconciliation ?](#comment-améliorer-la-réconciliation)
...
![Figure 6. - Recherche d'une nouvelle correspondance.](images/figure6-correspondance.png)
...
![Figure 7. Enrichir en ajoutant des propriétés et leurs valeurs](images/figure7-enrichissement.png)
...
![Figure 8. - Jeu des données enrichies.](images/figure8-jeu-donnees-enrichies.png)
...
Je remercie [Maxime Guénette](https://github.com/maxguen) qui a suscité, relu et ajouté de nombreux conseils à cette leçon; [Caroline Patenaude](https://github.com/crlnp/) pour sa relecture; Laurence Charest et Teresa Bascik pour leurs tests de versement de OpenRefine vers Wikidata; et enfin la communauté Wikimédia et Wikidata pour leurs contributions.
