# Enrichir ses données avec le processus de réconciliation d’OpenRefine et Wikidata

Pascal Martinolli 2025-05-26
...
Cette méthode est semblable à la formule RECHERCHEV (*VLOOKUP*) de LibreOffice Calc. Ce n’est pas tout à fait de la réconciliation, car c’est un appariement strict entre deux tables, basé sur une colonne commune contenant une clé. Ce [billet en anglais de Ruth Tillman](https://ruthtillman.com/talk/cell-cross-webinar-2020-03/) explique ce processus de croisement de cellules (*cell cross*).
